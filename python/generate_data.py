    ...
    if weeks[week][1] in [4, 6, 9, 11]:
        for i in range(5):
            ...
            if day > 30:
                ...
                month += 1
            if day < 10:
                days['0' + str(day) + '_' + str(month)] = [day, month]
            else:
                days[str(day) + '_' + str(month)] = [day, month]
    elif weeks[week][1] == 2:
        for i in range(5):
            day = weeks[week][0] + i
            month = weeks[week][1]
...
for day in list(days.keys()):
    for school in list(schools.keys()):
        for atmotube in range(1,6):
            ...
            date = datetime.datetime(2021, days[day][1], days[day][0], 0, 0, 0)
            ...
            df.to_csv(school + str(atmotube) + '__' + day + '.csv', index=False)
            print('Saved ' + school + str(atmotube) + '__' + day + '.csv')
